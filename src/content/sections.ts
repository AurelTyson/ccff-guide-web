...
export const SECTIONS: RouteMeta[] = [
  ...
  },
  {
    id: 'vigilance',
    path: 'vigilance',
    title: 'Vigilance incendie de forêt',
    short: 'Vigilance',
    icon: '🚦',
    accent: 'orange',
    summary:
      'Information journalière : niveau de risque et accès aux massifs du jour (Hérault).',
    keywords: [
      'vigilance',
      'risque du jour',
      'accès massifs',
  ...
  },
  {
    ...
    accent: 'green',
    summary:
      'Les 8 zones météo de l’Hérault et le carroyage DFCI (coordonnées 1/25000).',
    keywords: ['zones météo', 'carroyage', 'DFCI', 'coordonnées', 'carte', 'Hérault'],
    tile: true,
  },
  {
    id: 'alphabet',
